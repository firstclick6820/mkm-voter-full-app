...
import { CapitalizedFirstLetter, partialLetters } from '../../utils/General'
                                    ...
                                    <div className="flex items-center pt-3">
                                            ...
                                            <div className="ml-4 flex justify-start items-center">
                                                <p className=" font-sm hover:underline decoration-2 hover:text-red-600 ">
                                                    ...
                                                    {poll.user_details.first_name === null ?  poll.created_by.email : poll.user_details.first_name  }
                                                    </Link>
                                                </p>
                                ...
                                <div className="px-6 py-4 border-t border-gray-200 flex justify-between">
                                    <form className="w-full" method="POST" onSubmit={handleSubmit}>
                                        ...
                                        <div className="mb-6 mt-12 text-center">
                                            <button
                                                className={`${(selectedValue === null) ?  "bg-red-200": "bg-red-600" } w-full px-4 py-2 font-bold text-white rounded-full  focus:outline-none focus:shadow-outline `}
